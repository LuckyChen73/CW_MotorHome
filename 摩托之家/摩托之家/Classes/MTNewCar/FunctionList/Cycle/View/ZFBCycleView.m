...
#warning mark - 少用它,此处用了它,它会让collecitonView中的cell布局也就是计算itemSize,可能会有问题
    //        [self layoutIfNeeded];
    //
    //        // 要滚动到的索引
...
#warning mark - 因为默认滚动写在了初始化里面这个时候还没有数据,所以也就没有分好组和cell的个数
#warning mark - 最后封装后不要用它了
//    [self layoutIfNeeded];
//    
//    // 要滚动到的索引
//    NSIndexPath *scrollToPath = [NSIndexPath indexPathForItem:0 inSection:ZFBCycleSectionCount / 2];
